...
async function generateInterViewReportController(req, res) {
    ...
    //Temporary
    //console.log("EXTRACTED TEXT LENGTH:", resumeContent.text.length)
    //console.log("FIRST 300 CHARS:", resumeContent.text.slice(0, 300))
...
/**
 * @description Controller to delete an interview report by interviewId, scoped to the logged-in user.
 */
