...
const Home = () => {
    ...
    e.stopPropagation()
    const confirmed = window.confirm("Are you sure you want to delete this interview plan? This cannot be undone.")
    if (confirmed) {
                    ...
                    <ul className='reports-list'>
                        {reports.map(report => (
                            <li key={report._id} className='report-item' onClick={() => navigate(`/interview/${report._id}`)}>
                                ...
                                <button className='report-item__delete' onClick={(e) => handleDelete(e, report._id)}>
                                🗑️ Delete
                                </button>
                            </li>
                        ))}
