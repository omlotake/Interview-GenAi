                        ...
                        <section>
                            ...
                            <div className='q-list'>
                                {technicalQuestions.length > 0 ? (
                                    ...
                                    <p className='content-empty'>No technical questions were generated for this report.</p>
                                )}
                            </div>
                        </section>
                    )}
                        ...
                        <section>
                            ...
                            <div className='q-list'>
                                {behavioralQuestions.length > 0 ? (
                                    ...
                                    <p className='content-empty'>No behavioral questions were generated for this report.</p>
                                )}
                            </div>
                        </section>
                    )}
                        ...
                        <section>
                            ...
                            <div className='roadmap-list'>
                                {preparationPlan.length > 0 ? (
                                    ...
                                    <p className='content-empty'>No preparation roadmap was generated for this report.</p>
                                )}
                            </div>
                        </section>
                    )}
                    ...
                    <div className='skill-gaps'>
                        ...
                        <div className='skill-gaps__list'>
                            {skillGaps.length > 0 ? (
                                ...
                                <p className='content-empty'>No skill gaps identified.</p>
                            )}
                        </div>
                    </div>
